...
async function main() {
  ...
  for (const person of people) {
    ...
    const existing = await pb.collection('personal_compensation_periods').getFullList({
    ...
    await pb.collection('personal_compensation_periods').create({
      ...
      shifts,
      observations: 'Periodo inicial generado desde los datos actuales del personal.',
    });
